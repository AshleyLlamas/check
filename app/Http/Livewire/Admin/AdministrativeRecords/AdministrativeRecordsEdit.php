...
class AdministrativeRecordsEdit extends Component
{
    ...
    public function mount(AdministrativeRecord $administrative_record){
        ...
        $this->comentarios_del_colaborador = $administrative_record->comentarios_del_colaborador;
    ...
    public function save(){
        ...
        $this->administrative_record->comentarios_del_colaborador = $this->comentarios_del_colaborador;
